...
export async function GET() {
  try {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "온일장");
    ...
    return new Response(buffer, {
      headers: {
        ...
        "Content-Disposition": `attachment; filename="oniljang_upload_${today}.xlsx"`,
      },
    });
  } catch (err: unknown) {
    console.error("Oniljang Excel API error:", err);
